...
void SpriteSystem::enter(const Time&) {
	for (auto& b : m_batches) {
		b.second.vertices.clear();
	}
}

void SpriteSystem::process(const Time& time) {
...
void SpriteSystem::leave(const Time&) {
...
void SpriteSystem::constructSprite(EntityRegistry&, Entity entity) {
